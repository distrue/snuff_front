    ...
    >
      ...
      <ResultStyle>
        ...
        <div className="ctr">
          ...
          <div className="dtl">
            <div className="col1">240개 식당</div>
...
const ResultStyle = styled.div`
  display: block; position: relative; width: 200px; height: 400px; left: -30px;
  .ctr {
    display: flex; position: absolute; top: 100px; left: 81px; 
    flex-direction: column;
    .crownicon {
      position: absolute; top: 230px; left: -20px; width: 21.2px;
  height: 16.2px;
    }
    .dtl {
      position: relative; display: block; width: 100px; height: 30px;
      margin-bottom: 10px;
      .col1 {color: #1eccf9; position: absolute; top: 0px; left: 0px;}
      .col2 { position: absolute; top: 0px; left: 70px;}
      .col3 { position: absolute; top: 0px; left: 85px;}
      .col4 { position: absolute; top: 0px; left: 55px; width: 80px;}
      .col5 { position: absolute; top: -2px; left: 20px;
        text-align: center;
        width: 33px;
  height: 20px;
  font-size: 20px;
  ...
  color: #000000;}
  .normal1 {
    position: absolute;  top: 55px; left: 191px;
    width: 10px;
    height: 15px;
    font-size: 12px;
    font-weight: normal;
...
const TowerStyle = styled.div`
  display: block; position: relative; width: 165px; height: 400px;
  .topl {
  ...
  .topr {
    position: absolute; top: 0px; left: 81px;
    width: 81.5px;
    height: 200.3px;
    width: 0;
    height: 0;
  ...
  .downl {
    position: absolute; top: 200.3px; left: 0px;
    width: 41px;
    height: 0;
    border-style: solid;
    border-width:  0 0 200px 41px;
  ...
  .downr {
    position: absolute; top: 200.3px; left: 81px;
    width: 41px;
    height: 0;
    border-style: solid;
    border-width:  0 41px 200px 0;
  ...
  .crownicon {
    position: absolute; top: 170px; left: 51px;
    width: 63.6px;  height: 48.6px;
  }
  .crowncnt  {
    position: absolute; top: 190px; left: 81px;
