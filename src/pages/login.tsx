...
export default withLocation((props: any) => {
  React.useEffect(() => {
    Axios.get(`${BackUri}/kakao_oauth/islogin`, { withCredentials: true }).then((ans) => {
      if (ans.data.islogin) {
      ...
      <img
        ...
        onClick={() =>
          window.location.replace(
            `https://kauth.kakao.com/oauth/authorize?client_id=${AppId}&redirect_uri=${RedirectUri}&response_type=code&scope=gender,talk_message,account_email,age_range,birthday`,
          )
        }
      />
    </div>
